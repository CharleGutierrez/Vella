    ...
    vscode.workspace.onDidChangeTextDocument(event => {
        ...
        if (doc.languageId === 'rust') {
            ...
            while ((match = regex.exec(text)) !== null) {
                ...
                const diagnostic = new vscode.Diagnostic(new vscode.Range(startPos, endPos), "Vella: Unbalanced Double-Entry Ledger Transaction detected", vscode.DiagnosticSeverity.Warning);
